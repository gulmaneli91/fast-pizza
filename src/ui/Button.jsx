...
function Button({children, disabled,to, type }) {
    ...
    const base=" text-sm bg-yellow-400 tracking-wide rounded-full uppercase font-semibold text-stone-800 inline-block hover:bg-yellow-300 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed ";
    
    const styles ={
        primary: base + 'px-4 py-3 md:px-6 md:py-4',
        small: base + 'py-2 px-2 md:px-5 md:py-2.5 text-xs',
        secondary: "border-stone-300  border-2 tracking-wide rounded-full uppercase font-semibold text-stone-400 inline-block hover:bg-stone-300 hover:text-stone-800 transition-colors duration-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5"
    }
